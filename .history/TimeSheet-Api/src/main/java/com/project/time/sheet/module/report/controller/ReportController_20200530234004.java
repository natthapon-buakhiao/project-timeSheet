...
public class ReportController {
	...
	public ResponseEntity<ResponseModel<List<ReportBean>>> inquiry(@RequestBody ReqInquiryAttendance req){
		ResponseModel<List<AttendanceBean>> res = new ResponseModel<List<ReportBean>>();
