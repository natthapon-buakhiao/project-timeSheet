...
public class TimeSheetApplication {
	...
	,HistoryRepository historyRepository,ProjectRepository projectRepository) {
		return args -> {
			...
			NameTitle t1 = new NameTitle();
			NameTitle t2 = new NameTitle();
			NameTitle t3 = new NameTitle();
			
			t1.setName("นาย");
			t2.setName("นาง");
			t3.setName("นางสาว");

			nameTitleRepositorty.save(t1);
			nameTitleRepositorty.save(t2);
			nameTitleRepositorty.save(t3);
