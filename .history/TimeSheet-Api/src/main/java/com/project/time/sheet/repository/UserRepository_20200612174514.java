...
public interface UserRepository extends JpaRepository<User, String> {
    ...
    "AND ATTENDANCE.SITE_CODE = :site_code) GROUP BY USER_PROFILE_MS.USER_CODE " +
    "HAVING COUNT(USER_PROFILE_MS.USER_CODE) > 0 "  , nativeQuery = true )
    List<UserProfileMsPk> findByAllStaff(@Param("line_manager")  String lineManager, @Param("site_code")  String siteCode);
