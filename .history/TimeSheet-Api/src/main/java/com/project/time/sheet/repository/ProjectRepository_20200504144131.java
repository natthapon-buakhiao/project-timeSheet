...
public interface ProjectRepository extends JpaRepository<Project, String> {
    ...
    @Query(value = "SELECT * PROJECT WHERE ATTENDANCE_ID = ?1 AND ACCOUNT_NO = ?2 ORDER BY TRANSACTION_ID",nativeQuery = true)
	List<Project> findByCustomerNoAndAccountNoAndOrderId(String customerNo, String accountNo);
