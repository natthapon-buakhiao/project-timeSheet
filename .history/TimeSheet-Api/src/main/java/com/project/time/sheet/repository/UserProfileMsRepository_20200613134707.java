...
public interface UserProfileMsRepository extends JpaRepository<UserProfileMs, UserProfileMsPk> {
    ...
    "INNER JOIN USER_PROFILE_MS ON USER_MS.USER_CODE = USER_PROFILE_MS.USER_CODE AND " + 
    "INNER JOIN ATTENDANCE ON USER_MS.USER_CODE = ATTENDANCE.USER_CODE "  , nativeQuery = true )
